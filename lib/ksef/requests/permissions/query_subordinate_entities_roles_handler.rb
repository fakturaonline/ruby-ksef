...
module KSEF
  module Requests
    module Permissions
      # Handler for querying subordinate entities roles
      class QuerySubordinateEntitiesRolesHandler
        ...
        def call(query_data: {}, page_size: nil, page_offset: nil)
          ...
          response = @http_client.post("permissions/query/subordinate-entities/roles", body: query_data, params: params)
          response.json
        end
      end
    end
